                                ...
                                <ul className="text_skill">
                                    <li>
                                        ...
                                        <div className="text_keterangan">
                                            Training to answer the challenges of
                                            technological developments in the
                                            service sector financial management
                                            that aims to equip trainees with
                                    ...
                                    <li>
                                        ...
                                        <div className="text_keterangan">
                                            ...
                                            coding with programming technology
                        ...
                        <TabPane tab="Training I" key="3">
                            <div className="content_expe">
                                <h3>
                                    ...
                                    <span className="company">
                                        <a href="www.facebook.com">
                                            @ Fresh Graduate Academy DTS KOMINFO
                                        </a>
                                    </span>
                                </h3>
                                ...
                                <ul className="text_skill">
                                    ...
                                    <li>
                                        ...
                                        <div className="text_keterangan">
                                            ...
                                            Machine Learning, and data twitter.
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="content_expe">
                                ...
                                <ul className="text_skill">
                                    <li>
                                        ...
                                        <div className="text_keterangan">
                                            Oracle Academy is a training program
                                            from Oracle that provides training
                                            that includes Database design and
                                            Database programming with SQL,
                                            Database programming with PL/SQL,
                                            Java Programming, and Java
                                            Fundamentals.
                                        </div>
                                    </li>
                                </ul>
